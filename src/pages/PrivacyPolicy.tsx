    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto prose prose-blue">
          <h1 className="text-3xl font-bold text-wareongo-blue mb-6">Privacy Policy</h1>
          <p>
            We, M/s Neuroware Technologies Private Limited, incorporated under the Companies Act, 2013, having its registered office at "B-21, Near Galleria Market, Gurgaon – 122022" represented by its members, hereinafter referred to as the "Company" (where such expression shall unless repugnant to the context thereof, be deemed to include its respective legal heirs, representatives, administrators, permitted successors and assigns.) The creator of this Privacy Policy ensures a steady commitment to Your privacy with regard to the protection of your invaluable information.
          </p>
          <p>
            This privacy policy contains information about the domain "WareOnGo" (hereinafter collectively referred to as the "Platform").
          </p>
          <p>
          ...
          <p>
            This Privacy Policy shall be in compliance with the General Data Protection Regulation (GDPR) in effect and any and all provisions that may read to the contrary shall be deemed to be void and unenforceable as of that date. If you do not agree with the terms and conditions of our Privacy Policy, including in relation to the manner of collection or use of your information, please do not use or access the Site. If you have any questions or concerns regarding this Privacy Policy, you should contact our Customer Support Desk at https://Wareongo.com
          </p>
          <p>
          ...
          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">DEFINITIONS</h2>
          <p>
            "We", "Our", and "Us" shall mean and refer to the Platform and/or the Company, as the context so requires.
            <br />"You", "Your", "Yourself", "Customer" shall mean and refer to natural and legal individuals who use the Platform and who are competent to enter into binding contracts, as per Indian laws.
            <br />"Customers" shall refer to those wishing to avail services provided by the Platform.
            <br />"Services" refer to providing a Platform for Customers to avail service including but not limited to warehousing and distribution services through this platform.
            <br />"Third Parties" refer to any Application, company or individual apart from the Customer and the creator of this Platform.
            <br />"Personal Information" shall mean and refer to any personally identifiable information that We may collect from You such as Name, Location, Email Id, Mobile number.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">INFORMATION WE COLLECT</h2>
          <h3 className="text-lg font-semibold mt-6 mb-3">Personal Information</h3>
          <p>
            We are committed to respecting Your online privacy. We further recognize Your need for appropriate protection and management of any Personal Information You share with us. We may collect the following personal information.
            <br />Personal information such as details like Name, Email, Phone, Address, Company name, any message, Details of requirement, Warehouse full details, Warehouse capacity (in sq ft), warehouse facilities etc.
            ...
            <br />Details of Website usage for analytics.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-3">Transactional Users</h3>
          <p>
            This privacy policy also applies to data we collect from Customers who are not registered as members of this site, including, but not limited to, browsing behaviour, pages viewed etc. We also collect and store the personal information provided by you from time to time on the Site. We only collect and use such information from you that we consider necessary for achieving a seamless, efficient and safe experience, customized to your needs including.
            <br />To enable the provision of services opted for by You.
            <br />To communicate necessary accounts and service related information from time to time.
            <br />To allow You to receive quality customer care services and data Collection.
            <br />To provide, analyze, administer, enhance and personalize Our services and marketing efforts, to process Your registration, Your orders and Your payments, and to communicate with You on these and other topics.
            <br />To comply with applicable laws, rules and regulations.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-3">Third Party Data</h3>
          <p>
            Where any service requested by You involves a third party, such information as is reasonably necessary by the Company to carry out your service request may be shared with such third party. We also do use your contact information to send you offers based on your interests and prior activity. The Company may also use the contact information internally to direct its efforts for service improvement but shall immediately delete all such information upon withdrawal of your consent for the same through the '**unsubscribe**' button or through an email to be sent to sales@wareongo.com
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-3">Financial Data</h3>
          <p>
          ...
          <p>
            The Company will not use your financial information for any purpose other than to complete a transaction with you. To the extent possible, we provide you with the option of not divulging any specific information that you wish for us not to collect, store or use. You may also choose not to use a particular service or feature on the Site and opt out of any non-essential communications from the platform.
          </p>
          <p>
          ...
          <p>
            Many of the features in the website do not require any information from our end to be collected. However there are certain sections of the platform which require sign in/signup or information to collect before access. Users may or may not use these features depending upon his/her consent.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-3">Refund Policy</h3>
          <p>
            The Company understand the value of time and thus is determined to dispatch the transport on the time schedule as fixed with their customers, however if due to any unavoidable reasons there is delay to match its deadline of dispacting the transport, then the company shall initiate the full process of refund of received amount, after receiving a request from the customer, and a refund is issued to the original payment method (in case of pre-paid transactions) to the bank account within seven working days.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">OUR USE OF YOUR INFORMATION</h2>
          <p>
            The information provided by you shall be used to provide and improve the service for you and all Customers.
            <br />For maintaining internal records.
            <br />For providing the Services.
            <br />For enhancing the Services provided.
            <br />For creating a listing on the website.
            <br />For public display, other than your personal details.
          ...
          <p>
            ...
            <br />We use Your tracking information such as IP addresses, and or Device ID to help identify you and to gather broad demographic information and make further services available to you. We use the information to analyze, administer, enhance and personalize our service and to process Your registration process, Your Orders and Payments etc.
            <br />We will not sell, license or trade Your personal information. We will not share your personal information with others unless they are acting under our instructions or we are required to do so by law.
            <br />Information collected via Our server logs includes Customers' IP addresses and the pages visited; this will be used to manage the web system and troubleshoot problems. We also use third-party analytics, tracking, optimization and targeting tools to understand how customers engage with our Platform so that we can improve it and cater personalized content/ads according to their preferences. In certain cases, we pass on your information to the third party who can provide you service in case it is consented by you. Filling up digital forms on the platform gives WareOnGo full rights to transfer your information to the service providers.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">HOW INFORMATION IS COLLECTED</h2>
          <p>
            ...
            <br />We will collect and use your personal information solely with the objective of fulfilling those purposes specified by us, within the scope of consent of the individual concerned or as required by law. We will only retain personal information as long as necessary for the fulfilment of those purposes. We will collect personal information by lawful and fair means and with the knowledge and consent of the individual concerned.
            <br />Personal data should be relevant to the purposes for which it is to be used, and, to the extent necessary for those purposes, should be accurate, complete, and up-to-date.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">EXTERNAL LINKS ON THE WEBSITE</h2>
          <p>
            The Website may include advertisements, hyperlinks to other websites, applications, content or resources. We have no control over any websites or resources, which are provided by companies or persons other than Us. You acknowledge and agree that we are not responsible for the availability of any such external sites or resources, and do not endorse any advertising, services/products or other materials on or available from such platforms or resources. You acknowledge and agree that We are not liable for any loss or damage which may be incurred by you as a result of the availability of those external sites or resources, or as a result of any reliance placed by you on the completeness, accuracy or existence of any advertising, products or other materials on, or available from, such websites or resources. These external websites and resource providers may have their own privacy policies governing the collection, storage, retention and disclosure of Your Personal Information that You may be subject to. We recommend that you enter the external Website and review their privacy policy.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">YOUR RIGHTS</h2>
          <p>
            ...
            <br />Unless subject to an exemption, you have the following rights with respect to your personal data.
            <br />The right to request a copy of your personal data which we hold about you;
            <br />The right to request for any correction to any personal data if it is found to be inaccurate or out of date;
            <br />The right to withdraw Your consent to the processing at any time;
            <br />The right to object to the processing of personal data;
            <br />The right to lodge a complaint with a supervisory authority.
            <br />The right to obtain information as to whether personal data are transferred to a third country or to an international organization.
            <br />Where you hold an account with any of our services, you are entitled to a copy of all personal data which we hold in relation to you. You are also entitled to request that we restrict how we use your data in your account when you log in.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">CONFIDENTIALITY</h2>
          <p>
            We further acknowledge that the Platform may contain information which is designated confidential by us and that you shall not disclose such information without our prior written consent. Your information is regarded as confidential and therefore will not be divulged to any third party, unless legally required to do so to the appropriate authorities. We will not sell, share, or rent your personal information to any third party or use your email address for unsolicited mail. Any emails sent by us will only be in connection with the provision of agreed services, and you retain sole discretion to seek for discontinuation of such communications at any point.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">OTHER INFORMATION COLLECTORS</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">OUR DISCLOSURE OF YOUR INFORMATION</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">CONTROL OF YOUR PASSWORD</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">SECURITY</h2>
          <p>
            ...
            <br />However, as effective as encryption technology is, no security system is impenetrable. Our Company cannot guarantee the security of our database, nor can we guarantee that information you provide won't be intercepted while being transmitted to the Company over the Internet.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">SEVERABILITY</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">AMENDMENT</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">CONSENT WITHDRAWAL, DATA DOWNLOAD & DATA REMOVAL REQUESTS</h2>
          <p>
            To withdraw your consent, or to request the download or delete your data with us for any or all our products & services at any time, please email to sales@wareongo.com from your registered email address.
          </p>

          <h2 className="text-xl font-bold text-wareongo-blue mt-8 mb-4">CONTACT US</h2>
          <p>
            If you have any questions or concerns regarding this privacy policy, you should contact us by sending an email to please email to sales@wareongo.com
          </p>
