    ...
    <div className="min-h-screen flex flex-col bg-wareongo-ivory">
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <span className="text-sm font-semibold text-wareongo-blue uppercase tracking-wider mb-4 block">Case Study 01</span>
          <h1 className="text-4xl md:text-5xl font-bold text-wareongo-blue mb-6">
            Headline placeholder for the first case study
          </h1>
