            ...
            <div className="space-y-8 lg:sticky lg:top-32">
              ...
              <div className="pt-8 border-t border-black/10 space-y-6">
                ...
                <div className="flex flex-col space-y-4">
                  <a href="mailto:hello@wareongo.com" className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-wareongo-blue group-hover:underline">hello@wareongo.com</p>
                    </div>
                  </a>
                  ...
                  <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-wareongo-blue group-hover:underline">+91 98765 43210</p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="bg-white border-black/10 focus-visible:ring-wareongo-blue/30"
                      required 
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-[140px] bg-white border-black/10 focus-visible:ring-wareongo-blue/30 resize-y"
