    ...
    <div className="flex flex-col items-center md:items-start">
      ...
      <div className="flex flex-col items-center md:items-start">
        <div className="flex items-center mb-2">
          <Icon className="h-6 w-6 text-wareongo-blue mr-2" />
          <h3 className="text-xl font-semibold text-wareongo-blue">{title}</h3>
        </div>
        <p className="text-wareongo-slate text-center md:text-left">{description}</p>
      </div>
    </div>
  );
};
