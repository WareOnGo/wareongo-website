    ...
    <section className="relative bg-wareongo-ivory overflow-hidden -mt-20 pt-20 min-h-screen flex items-center">
      ...
      <div className="relative container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          <h1 className="text-[clamp(1.5rem,6.5vw,3rem)] sm:text-5xl md:text-6xl lg:text-7xl font-bold text-wareongo-blue leading-tight mb-5 sm:mb-7 whitespace-nowrap tracking-tight sm:tracking-tight">
          ...
          <Link
            ...
            className="group inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-wareongo-blue text-white text-base font-medium px-8 py-4 rounded-lg hover:opacity-90 transition-opacity"
          >
            Request a Warehouse
