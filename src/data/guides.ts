    ...
    blocks: [
      ...
      { kind: 'h2', text: 'Standard commercial terms in Indian warehouse leases' },
      {
        ...
        table: {
          ...
          rows: [
            ['Security deposit', '3–6 months\' rent', 'Refundable, interest-free; strong tenants can negotiate it down'],
            ...
            ['Escalation', '~5% per year, or 15% every 3 years', 'It compounds — model the total cost over the full term'],
            ['Rent-free fit-out period', '15–60 days', 'Tied to fit-out scope; ask for it explicitly'],
            ['Notice period', '3–6 months after lock-in', 'Push for the same notice period on both sides'],
          ],
        },
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Security deposit', '3–6 months, interest-free', 'The cost of capital locked up'],
            ['GST on rent', '18%, input credit usually available', 'Cash-flow timing even when creditable'],
            ['Power & DG', 'Per-unit charges outside rent', 'Whether the sanctioned load covers your equipment'],
            ['Fit-out & reinstatement', 'One-time; spread it over the lock-in', 'Exit clauses on racking and electrical works'],
          ],
        },
      },
      {
